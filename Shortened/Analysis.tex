...
\cite{flanagan2015}, attempts to avoid the issue of parameterization by instead simply modelling the votes of the venire
...
\begin{figure}[h!]
  ...
  \begin{subfigure}{0.4\textwidth}
    \includegraphics[scale = 0.4]{StubbornCompPlot}
    \caption{\footnotesize Stubborn strike pattern}
    \label{fig:stubcomp}
  \end{subfigure}
  ~
  \begin{subfigure}{0.4\textwidth}
    \includegraphics[scale = 0.4]{PhillyCompPlot}
    \caption{\footnotesize Philadelphia strike pattern}
    \label{fig:philcomp}
  \end{subfigure}
  ~
  \begin{subfigure}{0.4\textwidth}
    \includegraphics[scale=0.4]{SunshineCompPlot}
...
\subsubsection{Political Affiliation in the Sunshine Data} \label{sec:polaff}

\begin{figure}[h!]
  \centering
  \includegraphics[width=0.7\textwidth]{RaceGenderPolit}
...
\subsubsection{Gender in the Sunshine Data}

\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.7]{RaceGenderStrike}
...
\begin{figure}[h!]
  \centering
  \includegraphics[scale=0.7]{GenderGenderStrike}
...
\begin{figure}[h!]
  \centering
  \begin{subfigure}{0.4\textwidth}
    \includegraphics[scale = 0.4]{StubGenderComp}
    \caption{\footnotesize Stubborn strike pattern}
    \label{fig:stubcompgen}
  \end{subfigure}
  ~
  \begin{subfigure}{0.4\textwidth}
    \includegraphics[scale = 0.4]{PhilGenderComp}
    \caption{\footnotesize Philadelphia strike pattern}
    \label{fig:philcompgen}
  \end{subfigure}
  ~
  \begin{subfigure}{0.4\textwidth}
    \includegraphics[scale = 0.4]{SunGenderComp}
...
\subsection{On Venire Selection}
